...
public class BookmarkManager {
    ...
    private static BookmarkDao dao = new BookmarkDao(); // for database
    ...
    // in this function we are downloading the web page
    ...
    public void saveUserBookmark(User user, Bookmark bookmark) {
        ...
        //Code that downloads web link bookmarks// we removed it and applied threading
        /*
    ...
    // eg of : explicit casting in inheritance , with the help of instanceof
    public void share(User user, Bookmark bookmark) {
        bookmark.setSharedBy(user);

        System.out.println("Data to be shared: ");
        if (bookmark instanceof Book){
            // we need to typecast it to tell the method whose method to call ( book or WebLink)
